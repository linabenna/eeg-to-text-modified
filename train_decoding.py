...
if __name__ == '__main__':
    home_directory = os.path.expanduser("C:/Users/PC/Desktop/EEG-To-Text-main/")
...
# Check if CUDA (GPU) is available
    ...
    if 'task1' in task_name:
        ...
        dataset_path_task1=os.path.normpath(os.path.join(home_directory,dataset_path_task1))
        with open(dataset_path_task1, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'task2' in task_name:
        dataset_path_task2 = 'datasets/ZuCo/task2-NR/pickle/task2-NR-dataset.pickle'
        dataset_path_task2=os.path.normpath(os.path.join(home_directory,dataset_path_task2))
        with open(dataset_path_task2, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'task3' in task_name:
        dataset_path_task3 = 'datasets/ZuCo/task3-TSR/pickle/task3-TSR-dataset.pickle'
        dataset_path_task3=os.path.normpath(os.path.join(home_directory,dataset_path_task3))
