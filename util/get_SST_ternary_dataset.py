...
def get_SST_dataset(SST_dir_path, ZuCo_used_sentences, ZUCO_SENTIMENT_LABELS):
    ...
    SST_sentences_file_path = os.path.normpath(os.path.join(SST_dir_path,'datasetSentences.txt'))
    if not os.path.isfile(SST_sentences_file_path):
        print(f'NOT FOUND file: {SST_sentences_file_path}')
    SST_labels_file_path = os.path.normpath(os.path.join(SST_dir_path,'sentiment_labels.txt'))
    if not os.path.isfile(SST_labels_file_path):
        print(f'NOT FOUND file: {SST_labels_file_path}')
    SST_dictionary_file_path = os.path.normpath(os.path.join(SST_dir_path,'dictionary.txt'))
...
if __name__ == '__main__':
    ...
    SST_dir_path = 'C:/Users/PC/Desktop/EEG-To-Text-main/dataset/stanfordsentiment/stanfordSentimentTreebank'
    ZuCo_task1_csv_path = 'C:/Users/PC/Desktop/EEG-To-Text-main/datasets/ZuCo/task_materials/sentiment_labels_task1.csv'
    ZUCO_SENTIMENT_LABELS = json.load(open('C:/Users/PC/Desktop/EEG-To-Text-main/datasets/ZuCo/task1-SR/sentiment_labels/sentiment_labels.json'))
