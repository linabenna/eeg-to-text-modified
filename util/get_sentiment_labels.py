...
sentiment_labels_task1_csv_path = 'C:/Users/PC/Desktop/EEG-To-Text-main/datasets/ZuCo/task_materials/sentiment_labels_task1.csv'
...
output_dir = f'C:/Users/PC/Desktop/EEG-To-Text-main/datasets/ZuCo/task1-SR/sentiment_labels'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

with open(os.path.join(output_dir, 'sentiment_labels.json'), 'w') as out:
    json.dump(sentiment_labels,out,indent = 4)
    print('write to C:/Users/PC/Desktop/EEG-To-Text-main/datasets/ZuCo/task1-SR/sentiment_labels/sentiment_labels.json')
