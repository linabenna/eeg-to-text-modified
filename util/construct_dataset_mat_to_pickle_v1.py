...
import pickle
import argparse
home_directory = "C:/Users/PC/Desktop/EEG-To-Text-main/"
...
if version == 'v1':
    ...
    input_mat_files_dir = os.path.normpath(os.path.join(home_directory, f"datasets/ZuCo/{task_name}/Matlab files"))
elif version == 'v2':
    # new version, mat73 
    ...
    for sent in matdata:
        ...
        if not isinstance(word_data, float):
            ...
            for word in word_data:
                ...
                # if isinstance(word.nFixations, np.ndarray) and word.nFixations.size > 0:
                # Proceed with the existing logic
                if isinstance(word.nFixations, int) and word.nFixations > 0:
            ...
            print(f'missing sent: subj:{subject_name} content:{sent.content.encode("utf-8", "ignore")}, return None')
